		...
		<div class="col-md-6 col-sm-8">
			<form class="form" name="form-cadastro-indicador" id="form-cadastro-indicador" action="{{ route('cria-indicador') }}" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" name="meta_1_tri" id="meta_1_tri" class="form-control">
				</div>
				<div class="form-group">
					<label for="meta_2_tri">Meta 2º Trimestre</label>
					<input type="text" name="meta_2_tri" id="meta_2_tri" class="form-control">
				</div>
				<div class="form-group">
					<label for="meta_3_tri">Meta 3º Trimestre</label>
					<input type="text" name="meta_3_tri" id="meta_3_tri" class="form-control">
				</div>
				<div class="form-group">
					<label for="meta_4_tri">Meta 4º Trismestre</label>
					<input type="text" name="meta_4_tri" id="meta_4_tri" class="form-control">
				</div>
